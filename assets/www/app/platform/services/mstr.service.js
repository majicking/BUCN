    ...
    function MstrService($http, $q) {
        return {
            getMasterList: function (type){
                ...
                $http.get('http://bucn.ghbacoin.com/api/mstr',
                    {
                        params: {
                            type: type
                        }
            ...
            getGradeList: function (userType){
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.get('http://bucn.ghbacoin.com/api/mstr/grade',
                    {
                        params: {
                            userType: userType
                        }
            ...
            getBizList: function (tradeTypeList, manual){
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.get('http://bucn.ghbacoin.com/api/mstr/biz',
                    {
                        params: {
            ...
            getAreaChildrenList: function (areaParentId){
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.get('http://bucn.ghbacoin.com/api/mstr/area',
                    {
                        params: {
            ...
            getTradeTypeList: function (tradeTypeList, biz, manual){
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.get('http://bucn.ghbacoin.com/api/mstr/trade',
                    {
                        params: {
                            tradeTypeList: tradeTypeList,
                            biz: biz,
