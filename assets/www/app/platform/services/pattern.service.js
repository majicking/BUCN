    ...
    function PatternService($http, $q) {
        return {
            ...
            patternAdd: function (model) {
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.post('http://bucn.ghbacoin.com/api/user/pattern_save', model).success(function (message) {
                    deferred.resolve(message.data);
                }).error(function (error) {
                    deferred.reject(error);
                });
            ...
            patternUpdateUsed: function (model) {
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.post('http://bucn.ghbacoin.com/api/user/pattern_update_used', model).success(function (message) {
                    deferred.resolve(message.data);
                }).error(function (error) {
                    deferred.reject(error);
                });
            ...
            getPatternByUser: function (userid) {
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.get('http://bucn.ghbacoin.com/api/user/getPatternByUser', {
                    params: {
                        currentUser: userid
                    }
                }).success(function (message) {
            ...
            getPatternByUUID: function (uuid) {
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.get('http://bucn.ghbacoin.com/api/user/getPatternByUUID', {
                    params: {
                        uuid: uuid
                    }
                }).success(function (message) {
            ...
            checkPattern: function (model) {
                var deferred = $q.defer();
                var promise = deferred.promise;
                $http.post('http://bucn.ghbacoin.com/api/user/checkPattern', model).success(function (message) {
                    deferred.resolve(message.data);
                }).error(function (error) {
                    deferred.reject(error);
                });
