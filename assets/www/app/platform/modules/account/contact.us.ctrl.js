...
(function () {
    ...
    ContactUsCtrl.$inject = ['$scope','$rootScope','$state','$ionicPopup', '$ionicLoading', 'AccountService'];
    function ContactUsCtrl($scope,$rootScope,$state,$ionicPopup, $ionicLoading, AccountService) {
        var vm = this;
        vm.showPage = true;
