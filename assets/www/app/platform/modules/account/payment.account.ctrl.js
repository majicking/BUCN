(function () {
    ...
    function PaymentAccountCtrl($rootScope, $sessionStorage, $scope, $localStorage,$ionicPopup, $ionicLoading, AccountService, $stateParams) {
        ...
        vm.model = {
            ...
            amount: '0',
            tradeAmount: '0',
            ydayTemporaryAmount: '0',
            ydayFixedAmount: '0',
            ydaySharedInterest: '0',
            ydayCommunityInterest: '0',
            //isDrawWeekday: '0',
        ...
        function doRefresh(){
            AccountService.getAsset(
                ...
                if (document.getElementById("ydayAmount") != null) {
                    var countUp3 = new CountUp("ydayAmount", 0, vm.model.ydayAmount, 2, 1);
                    countUp3.start();
                }
            }).error(function (error) {
            }).finally(function() {
