(function () {
    ...
    OtcMySellsDetailCtrl.$inject = ['$rootScope', '$scope', '$sessionStorage', '$ionicLoading', '$ionicPopup', '$ionicNativeTransitions', 'OtcService', 'BankCardService', 'AccountService', '$stateParams'];
    function OtcMySellsDetailCtrl($rootScope, $scope, $sessionStorage, $ionicLoading, $ionicPopup, $ionicNativeTransitions, OtcService, BankCardService, AccountService, $stateParams) {
        var vm = this;
