(function () {
    ...
    OtcMySellsAddCtrl.$inject = ['$rootScope', '$scope', '$sessionStorage', '$ionicLoading', '$ionicPopup', '$ionicNativeTransitions', 'OtcService', 'BankCardService', 'AccountService', '$stateParams'];
    function OtcMySellsAddCtrl($rootScope, $scope, $sessionStorage, $ionicLoading, $ionicPopup, $ionicNativeTransitions, OtcService, BankCardService, AccountService, $stateParams) {
        var vm = this;
